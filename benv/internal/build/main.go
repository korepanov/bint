...
fmt.Print("")
fmt.Print("")
setVar("root_source","benv/internal/nested_call_program.b")
defineVar("$SOURCE")
...
defineVar("$DEST")
setVar("$DEST", createFile(getRootSource(fmt.Sprintf("%v", "benv/internal/long_function_program.b"))))
...
defineVar("$SOURCE")
setVar("$SOURCE", openFile(getRootSource(fmt.Sprintf("%v", "benv/internal/long_function_program2.b"))))
defineVar("$sourceNewChunk")
setVar("$sourceNewChunk", EachChunk(getVar("$SOURCE").(*os.File)))
defineVar("$DEST")
setVar("$DEST", createFile(getRootSource(fmt.Sprintf("%v", "benv/internal/long_function_program.b"))))
...
copy_e:
fmt.Print("")
os.Remove(getRootSource("benv/internal/long_function_program2.b"))
undefineVar("command")
...
defineVar("$SOURCE")
setVar("$SOURCE", openFile(getRootSource(fmt.Sprintf("%v", "benv/internal/long_function_program.b"))))
defineVar("$sourceNewChunk")
setVar("$sourceNewChunk", EachChunk(getVar("$SOURCE").(*os.File)))
defineVar("$DEST")
setVar("$DEST", createFile(getRootSource(fmt.Sprintf("%v", "benv/internal/long_function_program2.b"))))
goto replace_s
goto change
change:
fmt.Print("")
