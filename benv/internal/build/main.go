...
if "#is_cond" == fmt.Sprintf("%v", getVar("$println_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$println_return_var")){
goto is_cond_end
}
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$reverse_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$reverse_return_var")){
goto is_cond_end
}
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$indexes_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$indexes_return_var")){
goto is_cond_end
}
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$ops_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$ops_return_var")){
goto is_cond_end
}
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$in_stack_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$in_stack_return_var")){
goto is_cond_end
}
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$func_end_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$func_end_return_var")){
goto is_cond_end
}
...
fmt.Print("")
fmt.Print("")
setVar("root_source","benv/internal/for_program.b")
defineVar("$SOURCE")
...
defineVar("$DEST")
setVar("$DEST", createFile(getRootSource(fmt.Sprintf("%v", "benv/internal/if_program.b"))))
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$init_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$init_return_var")){
goto is_cond_end
}
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$finish_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$finish_return_var")){
goto is_cond_end
}
...
finish_end:
fmt.Print("")
defineVar("$is_cond_return_var")
setVar("$is_cond_return_var", "")
defineVar("$is_cond_res")
setVar("$is_cond_res", false)
goto is_cond_end
goto is_cond
is_cond:
fmt.Print("")
...
undefineVar("op")
undefineVar("command")
if "#println" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto println
}
if "#println_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto println_end
}
if "#reverse" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto reverse
}
if "#_reverse_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _reverse_s
}
if "#_reverse_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _reverse_e
}
if "#reverse_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto reverse_end
}
if "#indexes" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto indexes
}
if "#_indexes_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _indexes_s
}
if "#_indexes_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _indexes_e
}
if "#reverse_res0" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto reverse_res0
}
if "#indexes_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto indexes_end
}
if "#ops" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto ops
}
if "#indexes_res0" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto indexes_res0
}
if "#_op_nums_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _op_nums_s
}
if "#_quotes_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _quotes_s
}
if "#_these_quotes_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _these_quotes_s
}
if "#_these_quotes_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _these_quotes_e
}
if "#_is_op_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _is_op_end
}
if "#_quotes_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _quotes_e
}
if "#_push_op_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _push_op_end
}
if "#_op_nums_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _op_nums_e
}
if "#reverse_res1" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto reverse_res1
}
if "#ops_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto ops_end
}
if "#in_stack" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto in_stack
}
if "#_in_stack_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _in_stack_s
}
if "#_no" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _no
}
if "#_in_stack_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _in_stack_e
}
if "#in_stack_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto in_stack_end
}
if "#func_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto func_end
}
if "#ops_res0" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto ops_res0
}
if "#ops_res1" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto ops_res1
}
if "#_braces_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _braces_s
}
if "#in_stack_res0" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto in_stack_res0
}
if "#_o_plus_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _o_plus_end
}
if "#in_stack_res1" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto in_stack_res1
}
if "#_c_plus_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _c_plus_end
}
if "#_braces_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto _braces_e
}
if "#func_end_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto func_end_end
}
if "#init" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto init
}
if "#init_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto init_end
}
if "#finish" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto finish
}
if "#finish_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto finish_end
}
if "#is_cond" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto is_cond
}
if "#ops_res2" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto ops_res2
}
if "#end_true" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto end_true
}
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto is_cond_end
}
if "#main" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto main
}
if "#init_res0" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto init_res0
}
if "#main_s" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto main_s
}
if "#main_e" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto main_e
}
if "#finish_res0" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto finish_res0
}
if "#main_end" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto main_end
}
if "#main_res0" == fmt.Sprintf("%v", getVar("$is_cond_return_var")){
goto main_res0
}
goto end_true
end_true:
...
if "#is_cond" == fmt.Sprintf("%v", getVar("$main_return_var")){
goto is_cond
}
...
if "#is_cond_end" == fmt.Sprintf("%v", getVar("$main_return_var")){
goto is_cond_end
}
