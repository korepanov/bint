...
defineVar("$ex0")
setVar("$ex0", false)
setVar("$ex0",Exists(fmt.Sprintf("%v","benv/internal/import_program.b")))
...
undefineVar("$ex0")
setVar("root_source","benv/internal/import_program.b")
goto _cond_exit0
goto _cond0_end
_cond0_end:
fmt.Print("")
setVar("root_source","benv/internal/trace_program.b")
fmt.Print("")
goto _cond_exit0
_cond_exit0:
fmt.Print("")
...
setVar("$sourceNewChunk", EachChunk(getVar("$SOURCE").(*os.File)))
defineVar("$DEST")
setVar("$DEST", createFile(getRootSource(fmt.Sprintf("%v", "benv/internal/bool_program.b"))))
...
fmt.Print("")
fmt.Print("")
if isEqual(ValueFoldInterface("benv/internal/import_program.b"), ValueFoldInterface(getVar("root_source"))){
print("")
}else{
goto _cond13_end
}
systemStack = append(systemStack, "benv/internal/bool_program.b")
systemStack = append(systemStack, "benv/internal/import_program.b")
...
fmt.Print("")
systemStack = append(systemStack, "benv/internal/bool_program.b")
systemStack = append(systemStack, "benv/internal/trace_program.b")
...
fmt.Print("")
fmt.Print("")
os.Remove(getRootSource("benv/internal/bool_program.b"))
if true{
print("")
}else{
goto _cond14_end
...
defineVar("$ex0")
setVar("$ex0", false)
setVar("$ex0",Exists(fmt.Sprintf("%v",sum(sum("benv/internal/trace/trace_program", getVar("$s0")), ".b"))))
if toBool(getVar("$ex0")){
print("")
}else{
goto _cond15_end
...
setVar("$s0",getVar("number"))
defineVar("$SOURCE")
setVar("$SOURCE", openFile(getRootSource(fmt.Sprintf("%v", sum(sum("benv/internal/trace/trace_program", getVar("$s0")), ".b")))))
defineVar("$sourceNewChunk")
setVar("$sourceNewChunk", EachChunk(getVar("$SOURCE").(*os.File)))
undefineVar("$s0")
defineVar("$s0")
...
setVar("$s0",getVar("number"))
defineVar("$DEST")
setVar("$DEST", createFile(getRootSource(fmt.Sprintf("%v", sum(sum("benv/internal/trace/bool_program", getVar("$s0")), ".b")))))
undefineVar("$s0")
...
setVar("$s0", "")
setVar("$s0",getVar("number"))
systemStack = append(systemStack, sum(sum("benv/internal/trace/bool_program", getVar("$s0")), ".b"))
undefineVar("$s0")
defineVar("$s0")
setVar("$s0", "")
setVar("$s0",getVar("number"))
systemStack = append(systemStack, sum(sum("benv/internal/trace/trace_program", getVar("$s0")), ".b"))
undefineVar("$s0")
...
setVar("$s0", "")
setVar("$s0",getVar("number"))
os.Remove(getRootSource(sum(sum("benv/internal/trace/bool_program", getVar("$s0")), ".b")))
undefineVar("$s0")
setVar("number",sum(getVar("number"), 1))
goto for3
goto _cond15_end
