...
#next:print("");
switch_command();
if(NOT("end"==command)){print("");
sold_num=str(old_num);
buf2=("#_for"+sold_num);
buf_len=len(buf2);
if(len(command)>buf_len){print("");
if(command[0:buf_len]==buf2){print("");
if(was_internal_for){print("");
was_shift=True;
...
print("");
if(is_for(command)){print("");
was_for=True;
was_internal_for=False;
command_len=len(command);
command=command[4:command_len];
if(NOT(was_shift)){print("");
send_command(command);
};
print("");
old_command=command;
...
#next_internal:print("");
switch_command();
if(COMMAND_COUNTER<counter){print("");
if(is_for(command)){print("");
...
print("");
if(was_internal_for){print("");
if(COMMAND_COUNTER>internal_counter){print("");
was_internal_for=False;
};
print("");
};
print("");
if(("break"==command)AND(NOT(was_internal_for))){print("");
command=(("$for"+snum)+"=True");
send_command(command);
command=(("goto(#_undef_for"+snum)+")");
};
print("");
if(("continue"==command)AND(NOT(was_internal_for))){print("");
send_command(inc);
command=(("goto(#_undef_for"+snum)+")");
};
print("");
...
send_command(command);
if(is_var_def(old_command)){print("");
