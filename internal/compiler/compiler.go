...
func compile(systemStack []interface{}, OP string, LO []interface{}, RO []interface{}, typeLO string, typeRO string,
	...
	if "print" == OP {
		...
		panic("data type mismatch in index() operation, expected string and string, got " + typeLO + " and " + typeRO)
		...
		panic("compiler.go: could not compile len() operation")
	} else if "exists" == OP {
		var lenLO string
		isVarLO := false
		var computedLO bool
