...
var CompilerVars map[string]string // карта, которая хранит соответствие имен переменных кучи и номеров имен переменных asm
...
var SystemStackSize = 128          // количество временных переменных в asm для хранения вычисляемых значений системного стека
